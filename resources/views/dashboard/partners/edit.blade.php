...
@section('page_title', 'Edit Item Partner')
@push('breadcrumbs')
    <!--begin::Item-->
            ...
            <div class="card">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">Edit Partner</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    @endif
                    <!--begin::Form-->
                    <form id="kt_form" class="form" action="{{ route('dashboard.partners.update', $partner->id) }}"
                        method="POST" data-kt-redirect-url="{{ route('dashboard.partners.index') }}"
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="keterangan"
                                        ...
                                        value="{{ old('keterangan', $partner->keterangan) }}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true"
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px img-fluid"
                                            style="background-image: url({{ asset('storage/' . $partner->logo) }});">
                                        </div>
                                        ...
                                        <label
                                            ...
                                            <!--begin::Inputs-->
                                            <input type="file" name="logo" value="{{ old('logo', $partner->logo) }}"
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="is_active" class="form-select" data-control="select2"
                                        ...
                                        <option value=1 @if (old('is_active', $partner->is_active) == 1) selected @endif>
                                            AKTIF</option>
                                        <option value=0 @if (old('is_active', $partner->is_active) == 0) selected @endif>
                                            NONAKTIF</option>
                                    </select>
                                </div>
                                <!--end::Col-->
