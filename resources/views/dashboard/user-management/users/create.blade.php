            ...
            <div class="card">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">Tambah Pegawai Baru</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    <form id="kt_users_create_form" class="form" method="POST"
                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-semibold fs-6 required">Nomor Induk Pegawai</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                    ...
                                    <select name="roles[]" class="form-select" data-control="select2" multiple="multiple"
                                        ...
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->name }}"
                                                {{ in_array($role->name, old('roles', [])) || (isset($user) && $user->getRoleNames()->contains($role->name)) ? 'selected' : '' }}>
                                                {{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
