...
@push('breadcrumbs')
    ...
    <li class="breadcrumb-item text-muted"><a class="text-muted text-hover-primary"
            href="{{ route('dashboard.users.index') }}">Pengguna</a></li>
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item">
        <span class="bullet bg-gray-400 w-5px h-2px"></span>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    data-bs-target="#kt_users" aria-expanded="true" aria-controls="kt_users">
                    <!--begin::Card title-->
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">Edit Pegawai</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    @endif
                    <!--begin::Form-->
                    <form id="kt_users_create_form" class="form" method="POST"
                        action="{{ route('dashboard.users.update', $user->nip) }}"
                        data-kt-redirect-url="{{ route('dashboard.users.index') }}" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label fw-semibold fs-6">Nomor Induk Pegawai
                                    <!--begin::Hint-->
                            ...
                            <div class="row mb-6">
                                ...
                                <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                    ...
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                        title="Nama lengkap tanpa gelar"></i>
                                </label>
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="nama_lengkap"
                                        class="form-control form-control-lg form-control-solid" placeholder="Nama Lengkap"
                                        value="{{ old('nama_lengkap', $user->nama_ptgs) }}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <select name="roles[]" class="form-select" data-control="select2" multiple="multiple"
                                        data-actions-box="true" data-placeholder="Pilih Role" data-allow-clear="true">
                                        @foreach ($roles as $role)
                                            <option value="{{ $role->name }}"
                                                {{ in_array($role->name, old('roles', [])) || $user->getRoleNames()->contains($role->name) ? 'selected' : '' }}>
                                                {{ $role->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="country" aria-label="Select a Country" data-control="select2"
                                        ...
                                        <option data-kt-flag="flags/bolivia.svg" value="BO">Bolivia, Plurinational
                                            State of</option>
                                        <option data-kt-flag="flags/bonaire.svg" value="BQ">Bonaire, Sint Eustatius
                                            and Saba</option>
                        ...
                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                            ...
                            <button type="submit" class="btn btn-primary" id="kt_users_create_submit">
...
@endsection
@push('scripts')
    <script src="{{ asset('assets/metro1/') }}/js/users/create.js"></script>
    <script>
