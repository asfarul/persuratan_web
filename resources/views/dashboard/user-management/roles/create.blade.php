...
@push('breadcrumbs')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">Buat Role</li>
    <!--end::Item-->
@endpush
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">Buat Role Baru</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    @endif
                    <!--begin::Form-->
                    <form id="kt_roles_form" class="form" action="{{ route('dashboard.roles.store') }}" method="POST"
                        data-kt-redirect-url="{{ route('dashboard.roles.index') }}">
                        @csrf
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <select name="permissions[]" class="form-select" data-control="select2"
                                        multiple="multiple" data-actions-box="true" data-placeholder="Pilih hak akses"
