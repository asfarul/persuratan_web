...
@section('page_title', 'Nama Tanda Tangan')
@push('styles')
...
@push('breadcrumbs')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">Nama Tanda Tangan</li>
    <!--end::Item-->
@endpush
@section('content')
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                            ...
                            <!--end::Filter-->
                            <!--begin::Add user-->
                            <a class="btn btn-primary" href="{{ route('dashboard.tandatangan.create') }}">
...
@push('scripts')
    <script>
        var dataTable = $('#dataTable').DataTable({
            ...
            ajax: {
                url: "{!! route('dashboard.tandatangan.index') !!}",
                data: function(data) {
        ...
        dataTable.on('click', '.btn-delete', function() {
            var id = $(this).data('id');
            var url = '{!! route('dashboard.tandatangan.destroy', ':id') !!}';
