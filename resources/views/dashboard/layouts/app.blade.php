...
<head>
    <base href="../" />
    <title>PERSURATAN WEB | @yield('title')</title>
    <meta charset="utf-8" />
    <meta name="description" content="Admin Panel Sistem Front Office PERSURATAN WEB" />
    {{-- <meta name="keywords"
        content="bank, bpd, papan digital, suku bunga" />
    ...
    <link href="{{ asset('assets/metro1/') }}/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('assets/metro1/') }}/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet"
        type="text/css" />
...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true"
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!--begin::Header-->
            @include('dashboard.layouts.widgets.header')
            <!--end::Header-->
            <!--begin::Wrapper-->
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                <!--begin::Sidebar-->
                @include('dashboard.layouts.widgets.sidebar')
                <!--end::Sidebar-->
                <!--begin::Main-->
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                                ...
                                <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                                        ...
                                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10"
                                            style="background-color: #F1416C;background-image:url('{{ asset('assets/metro1/') }}/media/patterns/vector-1.png')">
                                            <!--begin::Header-->
                                            ...
                                            <div class="card-body d-flex flex-column justify-content-end pe-0">
                                                ...
                                                <div class="symbol-group symbol-hover flex-nowrap">
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle"
                                                        ...
                                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-11.jpg" />
                                                    </div>
                                                    <div class="symbol symbol-35px symbol-circle"
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle"
                                                        ...
                                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-2.jpg" />
                                                    </div>
                                                    <div class="symbol symbol-35px symbol-circle"
                                                    ...
                                                    <div class="symbol symbol-35px symbol-circle"
                                                        ...
                                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-12.jpg" />
                                                    </div>
                                        ...
                                        <div class="card card-flush h-lg-50">
                                            ...
                                            <div class="card-body pt-5">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    <!--begin::Section-->
                                                    <a href="#"
                                                        class="text-primary fw-semibold fs-6 me-2">Google Ads CPC</a>
                                                    <!--end::Section-->
                                                    <!--begin::Action-->
                                                    <button type="button"
                                                        class="btn btn-icon btn-sm h-auto btn-color-gray-400 btn-active-color-primary justify-content-end">
                                    ...
                                    <div class="col-xxl-6">
                                        ...
                                        <div class="card card-flush h-md-100">
                                            ...
                                            <div class="card-body d-flex flex-column justify-content-between mt-9 bgi-no-repeat bgi-size-cover bgi-position-x-center pb-0"
                                                style="background-position: 100% 50%; background-image:url('{{ asset('assets/metro1/') }}/media/stock/900x600/42.png')">
                                                <!--begin::Wrapper-->
                                                <div class="mb-10">
                                                    <!--begin::Title-->
                                                ...
                                                <img class="mx-auto h-150px h-lg-200px theme-light-show"
                                                    src="{{ asset('assets/metro1/') }}/media/illustrations/misc/upgrade.svg"
                                                    alt="" />
                                                <img class="mx-auto h-150px h-lg-200px theme-dark-show"
                                                    src="{{ asset('assets/metro1/') }}/media/illustrations/misc/upgrade-dark.svg"
                                                    alt="" />
                                                <!--end::Illustration-->
                                            </div>
                                            <!--end::Body-->
                                            ...
                                            <div class="card-body pt-6">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade" id="kt_chart_widget_8_week_tab"
                                                        ...
                                                        <!--end::Statistics-->
                                                        <!--begin::Chart-->
                                                        <div id="kt_chart_widget_8_week_chart"
                                                            class="ms-n5 min-h-auto" style="height: 275px"></div>
                                                        <!--end::Chart-->
                                                        <!--begin::Items-->
                                                    ...
                                                    <div class="tab-pane fade active show"
                                                        ...
                                                        <!--end::Statistics-->
                                                        <!--begin::Chart-->
                                                        <div id="kt_chart_widget_8_month_chart"
                                                            class="ms-n5 min-h-auto" style="height: 275px"></div>
                                                        <!--end::Chart-->
                                                        <!--begin::Items-->
                                                        <div class="d-flex flex-wrap pt-5">
                                                                ...
                                                                <thead>
                                                                    <tr
                                                                        ...
                                                                        <th class="p-0 pb-3 min-w-150px text-start">
                                                                            AUTHOR</th>
                                                                        <th
                                                                            class="p-0 pb-3 min-w-100px text-end pe-13">
                                                                            CONV.</th>
                                                                ...
                                                                <tbody>
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-3.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-2.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-9.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-7.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-25.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-24.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-20.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-17.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-11.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-23.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-4.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-1.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-12.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-21.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-30.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-14.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-6.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-flex align-items-center">
                                                                                <div class="symbol symbol-50px me-3">
                                                                                    <img src="{{ asset('assets/metro1/') }}/media/avatars/300-10.jpg"
                                                                                        class=""
                                                                                        alt="" />
                                                                                </div>
                                                                                <div
                                                ...
                                                <div class="row gx-9 h-100">
                                                    ...
                                                    <div class="col-sm-6 mb-10 mb-sm-0">
                                                        ...
                                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100"
                                                            style="background-size: 100% 100%;background-image:url('{{ asset('assets/metro1/') }}/media/stock/600x600/img-65.jpg')">
                                                        </div>
                                                        <!--end::Image-->
                                                    </div>
                                                    <!--end::Col-->
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="d-flex flex-column h-100">
                                                            ...
                                                            <div class="mb-6">
                                                                <!--begin::Text-->
                                                                <span
                                                                    class="fw-semibold text-gray-600 fs-6 mb-8 d-block">Flat
                                                                    cartoony illustrations with vivid unblended colors
                                                                    and asymmetrical beautiful purple hair lady</span>
                                                                <!--end::Text-->
                                                                <!--begin::Stats-->
                                                                <div class="d-flex">
                                                                    <!--begin::Stat-->
                                                                    <div
                                                                        ...
                                                                        <!--begin::Date-->
                                                                        <span class="fs-6 text-gray-700 fw-bold">Feb 6,
                                                                            2021</span>
                                                                        <!--end::Date-->
                                                                        <!--begin::Label-->
                                                                        <div class="fw-semibold text-gray-400">Due Date
                                                                        </div>
                                                                        <!--end::Label-->
                                                                    </div>
                                                                    <!--end::Stat-->
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <!--end::Number-->
                                                                        <!--begin::Label-->
                                                                        <div class="fw-semibold text-gray-400">Budget
                                                                        </div>
                                                                        <!--end::Label-->
                                                                    </div>
                                                                    <!--end::Stat-->
                                                            ...
                                                            <div class="d-flex flex-stack mt-auto bd-highlight">
                                                                ...
                                                                <div class="symbol-group symbol-hover flex-nowrap">
                                                                    <div class="symbol symbol-35px symbol-circle"
                                                                        data-bs-toggle="tooltip" title="Melody Macy">
                                                                        <img alt="Pic"
                                                                            src="{{ asset('assets/metro1/') }}/media/avatars/300-2.jpg" />
                                                                    </div>
                                                                    <div class="symbol symbol-35px symbol-circle"
                                                                        data-bs-toggle="tooltip"
                                                                        title="Michael Eberon">
                                                                        <img alt="Pic"
                                                                            src="{{ asset('assets/metro1/') }}/media/avatars/300-3.jpg" />
                                                                    </div>
                                                                    <div class="symbol symbol-35px symbol-circle"
                                                                        data-bs-toggle="tooltip"
                                                                        title="Susan Redwood">
                                                                ...
                                                                <a href="../../demo1/dist/apps/projects/project.html"
                                                                    ...
                                                                    Project
                                                                    <i
                                                                        class="ki-outline ki-exit-right-corner fs-4 ms-1"></i></a>
                                                                <!--end::Actions-->
                                                            </div>
                                                            <!--end::Footer-->
                                                        </div>
                                        ...
                                        <div class="card card-flush h-md-100">
                                            ...
                                            <div class="card-header pt-5 mb-6">
                                                ...
                                                <h3 class="card-title align-items-start flex-column">
                                                    ...
                                                    <!--end::Statistics-->
                                                    <!--begin::Description-->
                                                    <span class="fs-6 fw-semibold text-gray-400">Avg. Agent
                                                        Earnings</span>
                                                    <!--end::Description-->
                                                </h3>
                                                <!--end::Title-->
                                            ...
                                            <div class="card-header pt-7">
                                                ...
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-gray-800">Projects
                                                        Stats</span>
                                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Updated 37
                                                        minutes ago</span>
                                                </h3>
                                                <!--end::Title-->
                                                <!--begin::Toolbar-->
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="{{ asset('assets/metro1/') }}/media/stock/600x600/img-49.jpg"
                                                                                class="" alt="" />
                                                                        </div>
                                                                        <div
                                                                            class="d-flex justify-content-start flex-column">
                                                                            <a href="#"
                                                                                ...
                                                                                App</a>
                                                                            <span
                                                                                class="text-gray-400 fw-semibold d-block fs-7">Jane
                                                                                Cooper</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="{{ asset('assets/metro1/') }}/media/stock/600x600/img-40.jpg"
                                                                                class="" alt="" />
                                                                        </div>
                                                                        <div
                                                                            class="d-flex justify-content-start flex-column">
                                                                            ...
                                                                            <span
                                                                                class="text-gray-400 fw-semibold d-block fs-7">Esther
                                                                                Howard</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="{{ asset('assets/metro1/') }}/media/stock/600x600/img-39.jpg"
                                                                                class="" alt="" />
                                                                        </div>
                                                                        <div
                                                                            class="d-flex justify-content-start flex-column">
                                                                            <a href="#"
                                                                                ...
                                                                                CRM</a>
                                                                            <span
                                                                                class="text-gray-400 fw-semibold d-block fs-7">Jenny
                                                                                Wilson</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="{{ asset('assets/metro1/') }}/media/stock/600x600/img-47.jpg"
                                                                                class="" alt="" />
                                                                        </div>
                                                                        <div
                                                                            class="d-flex justify-content-start flex-column">
                                                                            <a href="#"
                                                                                ...
                                                                                Hill</a>
                                                                            <span
                                                                                class="text-gray-400 fw-semibold d-block fs-7">Cody
                                                                                Fisher</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="symbol symbol-50px me-3">
                                                                            <img src="{{ asset('assets/metro1/') }}/media/stock/600x600/img-48.jpg"
                                                                                class="" alt="" />
                                                                        </div>
                                                                        <div
                                                                            class="d-flex justify-content-start flex-column">
                                                                            <a href="#"
                                                                                ...
                                                                                Degree</a>
                                                                            <span
                                                                                class="text-gray-400 fw-semibold d-block fs-7">Savannah
                                                                                Nguyen</span>
                                                                        </div>
                                                                    </div>
                                                                </td>
                    ...
                    <!--end::Content wrapper-->
                    <!--begin::Footer-->
                    @include('dashboard.layouts.widgets.footer')
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="" class="w-30px me-3"
                                                src="{{ asset('assets/metro1/') }}/media/svg/files/pdf.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            ...
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="{{ asset('assets/metro1/') }}/media/svg/files/doc.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img alt="../../demo1/dist/apps/projects/project.html" class="w-30px me-3"
                                                src="{{ asset('assets/metro1/') }}/media/svg/files/css.svg" />
                                            <!--end::Icon-->
                                            <!--begin::Info-->
                                            <div class="ms-1 fw-semibold">
                                                <!--begin::Desc-->
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-29.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-31.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="overlay">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img alt="img" class="rounded w-150px"
                                                    src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-40.jpg" />
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Link-->
                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                    ...
                    <div class="d-flex justify-content-start mb-10">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ asset('assets/metro1/') }}/media/avatars/300-25.jpg" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Details-->
                                <div class="ms-3">
                    ...
                    <div class="d-flex justify-content-end mb-10">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ asset('assets/metro1/') }}/media/avatars/300-1.jpg" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::User-->
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-1.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-3.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-8.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-26.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-21.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-34.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/metro1/') }}/media/stock/600x400/img-27.jpg" alt="" />
                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                    <img src="{{ asset('assets/metro1/') }}/media/svg/card-logos/visa.svg" alt=""
                                                        class="h-25px" />
                                                    <img src="{{ asset('assets/metro1/') }}/media/svg/card-logos/mastercard.svg"
                                                        alt="" class="h-25px" />
                                                    <img src="{{ asset('assets/metro1/') }}/media/svg/card-logos/american-express.svg"
                                                        alt="" class="h-25px" />
                                                </div>
                                                <!--end::Card logos-->
                                            </div>
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="w-100 text-center">
                                        ...
                                        <div class="text-center px-4 py-15">
                                            <img src="{{ asset('assets/metro1/') }}/media/illustrations/sketchy-1/9.png" alt=""
                        ...
                        <div class="mh-375px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-6.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-6">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-1.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-6">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-5.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-6">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-25.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-6">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-9.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-6">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-23.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
                                    <div class="ms-6">
                        ...
                        <div class="py-5">
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-13.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic" src="{{ asset('assets/metro1/') }}/media/avatars/300-21.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="{{ asset('assets/metro1/') }}/media/illustrations/sketchy-1/1.png" alt=""
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img alt="Logo" src="{{ asset('assets/metro1/') }}/media/svg/brand-logos/google-icon.svg"
                    ...
                    <div class="mb-10">
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol s    ymbol-35px symbol-circle">
                                        <span class="symbol-label bg-light-primary text-primary fw-semibold">N</span>
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Details-->
    ...
    <!--begin::Javascript-->
    {{-- <script>
        var hostUrl = "{{ asset('assets/metro1/') }}";
    </script> --}}
    ...
    <script src="{{ asset('assets/metro1/') }}/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
    ...
    <script src="{{ asset('assets/metro1/') }}/plugins/custom/datatables/datatables.bundle.js"></script>
    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('assets/metro1/') }}/js/widgets.bundle.js"></script>
    <script src="{{ asset('assets/metro1/') }}/js/custom/widgets.js"></script>
