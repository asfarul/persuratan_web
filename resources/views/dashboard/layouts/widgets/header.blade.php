                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo1/dist/layouts/light-sidebar.html" class="menu-link active">
                                                        <span class="menu-bullet">
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px"
                        ...
                        <div class="symbol-label fs-3 bg-light-warning text-warning">
                            {{ substr(auth()->user()->nama_ptgs, 0, 1) }}
                        </div>
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                            ...
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        {{ auth()->user()->gelar_depan . ' ' . auth()->user()->nama_ptgs . ' ' . auth()->user()->gelar_belakang }}
                                        {{-- <span
                                            class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ auth()->user()->roles()->first()->name }}</span> --}}
                                    </div>
                                    <a href="#"
                                        class="fw-semibold text-muted text-hover-primary fs-7">{{ auth()->user()->nip }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('dashboard.myprofile.index') }}" class="menu-link px-5">My Profile</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="{{ route('dashboard.myprofile.edit') }}" class="menu-link px-5">Settings</a>
                        </div>
                        <!--end::Menu item-->
