...
@push('breadcrumbs')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">Edit Kantor Cabang</li>
    <!--end::Item-->
@endpush
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">Ubah Kantor Cabang</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    ...
                    @endif
                    <!--begin::Form-->
                    <form id="kt_form" class="form" action="{{ route('dashboard.cabang.update', $cabang->id) }}"
                        method="POST" data-kt-redirect-url="{{ route('dashboard.cabang.index') }}">
                        @csrf
                        @method('PUT')
                        <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="kode" value="{{ old('kode', $cabang->kode) }}"
                            ...
                            <div class="row mb-6">
                                <!--begin::Label-->
                                <label class="col-lg-4 col-form-label required fw-semibold fs-6">Nama Cabang</label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="nama"
                                        class="form-control form-control-lg form-control-solid {{ $errors->has('nama') ? 'is-invalid' : '' }}"
                                        placeholder="Masukkan nama role" value="{{ old('nama') ?? $cabang->nama }}" />
                                </div>
                                <!--end::Col-->
                            </div>
                            <!--end::Input group-->
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="alias" value="{{ old('alias') ?? $cabang->alias }}"
                            ...
                            <div class="row mb-6">
                                ...
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="alamat" value="{{ old('alamat') ?? $cabang->alamat }}"
