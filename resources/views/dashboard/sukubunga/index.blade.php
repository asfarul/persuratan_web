...
@section('title', 'Data Suku Bunga')
@section('page_title', 'Data Suku Bunga')
@push('styles')
...
@push('breadcrumbs')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">Suku Bunga</li>
    <!--end::Item-->
@endpush
@section('content')
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                            <!--end::Filter-->
                            <!--begin::Add user-->
                            <a class="btn btn-primary" href="{{ route('dashboard.sukubunga.create') }}">
...
@push('scripts')
    <script>
        ...
        var dataTable = $('#dataTable').DataTable({
            ...
            ajax: {
                url: "{!! route('dashboard.sukubunga.index') !!}",
                data: function(data) {
        ...
        dataTable.on('click', '.btn-delete', function() {
            var id = $(this).data('id');
            var url = '{!! route('dashboard.sukubunga.destroy', ':id') !!}';
