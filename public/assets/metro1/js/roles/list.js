...
// Class definition
var KTRolesDatatables = (function () {
    // Shared variables
    var table;
    var dt;
    var filterPayment;
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_roles").DataTable({ 
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [],
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="roles/${data}/edit" class="menu-link px-3">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" data-id=${data} class="menu-link px-3" data-kt-docs-table-filter="delete_row">
                                        Delete
                                    </a>
                                </div>
                                <!--end::Menu item-->
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_datatable_roles");
