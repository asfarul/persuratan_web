...
// Class definition
var KTPermissionDatatables = (function () {
    // Shared variables
    var table;
    var dt;
    var filterPayment;
    ...
    var initDatatable = function () {
        dt = $("#kt_datatable_permissions").DataTable({
            searchDelay: 500,
            processing: true,
            serverSide: true,
            order: [],
    ...
    var initToggleToolbar = function () {
        ...
        const container = document.querySelector("#kt_datatable_permissions");
